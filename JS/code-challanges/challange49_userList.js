//! Answer the questions according to the product list in JSON structure below.
...
//! a- Let's list the products and prices
...
//! b- Let's display the information of the first product with the object structure method.
//! title
//! description
//! price
//! category
...
//! c- Let's list the names and prices of laptops
...
//! d- Since our company has decided to publish products in the home-decoration category on a separate site, it will remove these products from its portfolio. Let's remove the products in this category from the list.
...
//! e- Let's delete the product selected by the user (the product whose id is entered) -delete
...
//! f- Let's add a new product - create
...
//! g- Let's update the prices with discounted prices using the rest operator - Update
...
//! h- Let's show how many products are in each category
